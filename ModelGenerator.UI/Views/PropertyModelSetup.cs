...
namespace ModelGenerator.UI.Views
{
    public partial class PropertyModelSetup : Form
    {
        ...
        private readonly IXMLDataProcessor xmlPropertyDataProcessor;
        private readonly IXMLService propertyTypeService;

        public PropertyModelSetup(ServiceResolverXML serviceResolverXML, IXMLPropertyTypesList propertyTypeList, IServiceProvider serviceProvider, IXMLDataProcessor xmlPropertyDataProcessor)
        {
            InitializeComponent();
            ...
            this.xmlPropertyDataProcessor = xmlPropertyDataProcessor;
        ...
        public PropertyTypeModel PropertyTypeInfo
        {
            ...
            set 
            {
                ...
                if (value != null)
                {
                    ...
                    TextArea.Text = value.ModelFormat;
                }
            }
        }
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (IsEdit)
            {
                this.propertyTypeService.Write(ModelName.Text, TextArea.Text);
            ...
            {
                this.propertyTypeService.Add(ModelName.Text, TextArea.Text);
                MessageBox.Show("Saved!", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
                this.Dispose();
            }
        ...
        {
            var delete = MessageBox.Show("Delete this property model?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (delete == DialogResult.Yes)
            {
                xmlPropertyDataProcessor.Delete(ModelList.SelectedItem.ToString());
                Init();
